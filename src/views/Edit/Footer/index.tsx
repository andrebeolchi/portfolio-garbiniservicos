							...
							<div className="sm:col-span-full">
								...
								<div className="mt-2.5 flex flex-row flex-1 justify-between items-center group">
									<div className="flex-1 flex flex-row mr-2.5">
										...
										<div className="flex flex-1 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-zinc-600">
											<input
												type="text"
												name="title"
												id="title"
								...
								<div className="sm:col-span-full">
									...
									{group.items?.map((item, groupItemIndex) => (
										<div
											...
											<div className="flex flex-1 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-zinc-600 mr-2.5">
												<input
													type="text"
													name="title"
													id="title"
