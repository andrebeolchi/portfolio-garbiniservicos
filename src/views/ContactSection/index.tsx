		...
		<div className="isolate bg-gray-50 px-6 py-24 sm:py-32 lg:px-8">
			<div className="relative">
				<div
					...
					aria-hidden="true">
					<div
						className="relative left-1/3 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#444444] to-[#555555] opacity-30 sm:left-[calc(50%)] sm:w-[72.1875rem]"
						style={{
							clipPath:
